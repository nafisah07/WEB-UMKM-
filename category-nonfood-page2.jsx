    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          ...
          <a href="category-nonfood-page2.html" className="pagination-item active">2</a>
          ...
          <a href="category-nonfood-page6.html" className="pagination-item">6</a>
          <a href="category-nonfood-page3.html" className="pagination-item"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>

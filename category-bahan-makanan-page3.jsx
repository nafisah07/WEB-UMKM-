...
const CategoryBahanMakananPage3 = () => (
  <>
        ...
        <ul>
          ...
          <li className="dropdown">
            ...
            <div className="dropdown-content">
              <a href="category-bahan-makanan.html" className="active">Bahan Makanan</a>
    ...
    <section className="category-hero">
      <div className="container">
        <h1>Bahan Makanan</h1>
        <p>Beras, minyak goreng, tepung, gula, dan bahan makanan pokok lainnya dengan kualitas terbaik</p>
      </div>
    </section>
    ...
    <section className="products-section">
      <div className="container">
        ...
        <div className="pagination">
          <a href="category-bahan-makanan.html" className="pagination-item">1</a>
          <a href="category-bahan-makanan-page2.html" className="pagination-item">2</a>
          <a href="category-bahan-makanan-page3.html" className="pagination-item active">3</a>
          <a href="#" className="pagination-item disabled"><i className="fas fa-chevron-right"></i></a>
        </div>
      </div>
    </section>
